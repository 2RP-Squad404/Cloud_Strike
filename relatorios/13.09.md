...
### Oque estou fazendo/ ou já fiz

Estou seguindo um plano de estudos sobre o Dataplex, uma ferramenta que ainda não foi muito explorada. O Dataplex é uma plataforma do Google Cloud voltada para a governança e gerenciamento de dados distribuídos, permitindo a organização, controle e monitoramento de dados em grande escala, especialmente em ambientes multi-cloud.

Comecei estudando governança de dados, que envolve o registro e gerenciamento do ciclo de vida de todos os ativos de dados dentro de uma empresa. O Dataplex facilita a criação de políticas e automação para garantir que os dados estejam com as normas e regulamentos. Ele organiza os dados em zonas de dados, que são utilizadas para classificar os dados com base na sua finalidade, origem ou outros critérios.

Em seguida, conversei com o João sobre a segurança no Dataplex, que envolve o controle de acesso por meio do IAM e criptografia de dados em trânsito. Isso garante que os dados sejam acessados de forma segura e por pessoas autorizadas. Até agora, ainda não coloquei nada em prática e também não tive propostas para projetos. No entanto, planejo iniciar a parte prática nessa semana.

### *Principais Desafios Enfrentados*
Um dos principais desafios que enfrentei até agora foi entender como configurar corretamente as zonas de dados e aplicar as políticas de acesso de forma eficiente. Além disso, ainda não encontrei muitos exemplos práticos e teóricos que me ajudem a ter uma visão clara de como implementar o Dataplex no dia a dia.

### *Dúvidas :*
Tenho algumas dúvidas sobre como utilizar o Dataplex na prática, principalmente relacionadas a:
...
* Buscar mais exemplos práticos ou tutoriais, além de consultar a documentação oficial e discutir mais profundamente com colegas como o João.  
...
https://cloud.google.com/dataplex/docs/lake-security?hl=pt-br

https://youtu.be/rDANpCVsO9s?si=EGTyEUx1-fLM_fCk

https://youtu.be/glxq7IXEyIY?si=THCwrTt39E9XQJEB

https://youtu.be/B3Ii9Phqkng?si=E75t8lMo2yAnyoCb

https://youtu.be/5-NtozDQVBQ?si=L9O__2d1lhYESsU8

https://youtu.be/2BNaO_KA-8o?si=DKGRj0vUItvDT6yi
